package com.herorickystudios.sockshttp.adapter;

import com.herorickystudios.ultrasshservice.logger.SkStatus;
import com.herorickystudios.ultrasshservice.logger.LogItem;
		...
		View.OnTouchListener
{
	...
	private Vector<AdapterDataObserver> observers = new Vector<AdapterDataObserver>();
	...
	@Override
	public void onBindViewHolder(@NonNull logViewHolder viewHolder, int position) {
		final String text;
		...
		viewHolder.textLog.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v)
			{
				if (itemClickListener != null)
					itemClickListener.onItemClick(v, finalPosition, text);
			}
		});
		...
		viewHolder.textLog.setOnLongClickListener(new View.OnLongClickListener() {
			...
			{
				if (itemClickListener != null)
					itemClickListener.onItemLongClick(v, finalPosition1, text);
				return true;
			}
		});
	}
