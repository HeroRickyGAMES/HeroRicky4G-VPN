...
import com.herorickystudios.ultrasshservice.aidl.IUltraSSHServiceInternal;
...
import com.herorickystudios.ultrasshservice.tunnel.TunnelManagerThread;
...
import com.herorickystudios.ultrasshservice.util.DummyActivity;
...
implements SkStatus.StateListener
{
    ...
    private void addVpnActionsToNotification(Notification.Builder nbuilder) {
		...
		reconnectVPN.setAction(MainReceiver.ACTION_SERVICE_RESTART);
      	PendingIntent reconnectPendingIntent = PendingIntent.getBroadcast(this, 0, reconnectVPN, FLAG_MUTABLE);
		...
		disconnectVPN.setAction(MainReceiver.ACTION_SERVICE_STOP);
      	PendingIntent disconnectPendingIntent = PendingIntent.getBroadcast(this, 0, disconnectVPN, FLAG_MUTABLE);
	...
	public static PendingIntent getGraphPendingIntent(Context context) {
		...
		PendingIntent startLW = PendingIntent.getActivity(context, 0, intent, FLAG_MUTABLE);
